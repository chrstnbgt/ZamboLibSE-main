...
if (isset($_GET['eventAnnouncementID'])) {
    $record = $announcement->fetch($_GET['eventAnnouncementID']);
...
if (isset($_POST['save'])) {
    $announcement->eventAnnouncementID = $_GET['eventAnnouncementID'];
    ...
    $announcement->eaEndDate = htmlentities($_POST['eaEndDate']); // Corrected assignment
                            ...
                            <div class="input-group flex-column mb-3">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="time" name="eaStartTime" id="eaStartTime" class="input-1 col-lg-12" placeholder="From" value="<?php if(isset($_POST['eaStartTime'])) { echo $_POST['eaStartTime']; }else if(isset($announcement->eaStartTime)) { echo $announcement->eaStartTime; } ?>">
                                    </div>
