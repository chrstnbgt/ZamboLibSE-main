...
if(isset($_POST['deleteImage']) && isset($_POST['event_ImageID'])){
    ...
    header("Location: ../webpages/event-gallery.php?librarianID=" . $_SESSION['librarianID'] . "&eventID=$eventID");
    exit();
}
                ...
                <div class="row pt-4 ps-4">
                    ...
                    <div class="row ps-2">
                        <div class="row club-overview-details-container">
                            <div class="row"style="height: 250px; overflow-y: auto;margin-top:10px;">
                            <?php
                                if (isset($images) && !empty($images)) {
                                    foreach ($images as $image) {
                                        $fileName = $image['eventImage']; // Get the filename from the database
                                        $imagePath = '../event_gallery/' . $fileName; // Adjust directory if necessary
