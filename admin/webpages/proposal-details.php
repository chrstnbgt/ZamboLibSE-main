                                ...
                                <div class="proposal-card mt-4 mx-4">
                                    <div class="row d-flex justify-content-between align-items-center mb-5">
                                        <div class="col-12 col-lg-7">
                                            <div class="proposalSubject mb-2"><strong>SUBJECT: </strong><?= isset($proposal['proposalSubject']) ? $proposal['proposalSubject'] : 'No Subject Available'; ?></div>
                                            <?php
                                        ...
                                        <div class="orgHead d-flex align-items-center mb-3">
                                            <?php
                                            $userID = isset($orgClubDetails['userID']) ? $orgClubDetails['userID'] : null;
                                            if ($userID) {
                                            ...
                                            <div class="proposalCreatedAT">
                                                <?= isset($proposal['proposalCreatedAt']) ? date('d M, Y h:i A', strtotime($proposal['proposalCreatedAt'])) : 'No Date Available'; ?>
                                            </div>
                                        </div>

                                    </div>

                                    <div class="proposalDescription"><?= isset($proposal['proposalDescription']) ? $proposal['proposalDescription'] : 'No Description Available'; ?></div>
                                    <div class="proposalFile mt-5">
                                        ...
                                        <div class="files ms-2">
                                            <div class="file-card">
                                                <?php
                                                if (isset($proposal['proposalFile'])) {
