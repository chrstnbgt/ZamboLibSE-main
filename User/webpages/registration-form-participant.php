...
if (isset($_POST['submit-answers'])) {
    ...
    if ($success) {
        header("Location: registration-success.php?id=$eventID");
        exit();
    } else {
        ...
        <div class="row d-flex justify-content-center">
            <div class="form-card col-12 col-md-8 col-lg-6 mt-lg-4 mb-5">
                <div class="header-form mb-3">
                    ...
                    <?php if ($isRegistered) { ?>
                        <p class="note-already mt-3">You're already registered for this event.</p>
                    <?php } else { ?>
                    ...
                    <div class="personal-information">
                        ...
                        <div class="row d-flex justify-content-center justify-content-lg-between">
                            ...
                            <div class="row d-flex justify-content-center justify-content-lg-between">
                                ...
                                <div class="input-group flex-column field_size5 mb-4">
                                    <label for="userZipCode" class="label mb-2">ZipCode</label>
                                    <input type="text" name="userZipCode" id="userZipCode" class="input-1" value="<?php echo $user->userZipCode ?>" readonly>
                                </div>
                            </div>

                            <div class="row d-flex justify-content-center justify-content-lg-between">
                                <div class="input-group flex-column field_size3 mb-3">
                                    <label for="userBarangay" class="label mb-2">Baranggay</label>
                                    <input type="text" name="userBarangay" id="userBarangay" class="input-1 me-lg-3" value="<?php echo $user->userBarangay ?>" readonly>
                                </div>
                                <div class="input-group flex-column field_size3">
                                    <label for="userStreetName" class="label mb-2">Street Name</label>
                                    <input type="text" name="userStreetName" id="userStreetName" class="input-1" value="<?php echo $user->userStreetName ?>" readonly>
                                </div>
                            </div>
                        </div>
                                ...
                                <form method="post" action="">
                                    <?php if ($isRegistered) { ?>
                                        ...
                                        <?php foreach ($registeredData as $data) { ?>
                                            <div class="mb-3">
                                                <label for="longTextField_<?php echo $data['eventRegQuestionID']; ?>" class="label ps-1"><?php echo $data['erQuestion']; ?></label>
                                                <textarea class="form-control" class="input-1" id="longTextField_<?php echo $data['eventRegQuestionID']; ?>" rows="3" readonly><?php echo $data['erAnswer']; ?></textarea>
                                            </div>
                                        <?php } ?>
                                    <?php } else { ?>
                                        <!-- Display registration form -->
                                        <?php if ($eventRegistrationFormData) { ?>
                                            <?php foreach ($eventRegistrationFormData as $data) { ?>
                                                <div class="mb-3">
                                                    <label for="longTextField_<?php echo $data['eventRegQuestionID']; ?>" class="label ps-1"><?php echo $data['erQuestion']; ?></label>
                                                    <textarea class="form-control" class="input-1" id="longTextField_<?php echo $data['eventRegQuestionID']; ?>" name="longTextField[<?php echo $data['eventRegQuestionID']; ?>]" rows="3" placeholder="Write a brief explanation." required><?php echo $data['erAnswer']; ?></textarea>
                                                </div>
                                            <?php } ?>
                                        <?php } else { ?>
